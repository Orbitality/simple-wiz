...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ را وارد  کنید ( حراف انگیلیسی و عدد باهم وارد  کنید )',
...
",
    ...
    'start_message'=>'سلام به ربات OrB خوش اومدی  
...
یکی از پلن هارا انتخاب  کنید و برا برای پرداختش", 
